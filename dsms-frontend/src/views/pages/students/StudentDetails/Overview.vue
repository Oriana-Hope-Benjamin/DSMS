...
// expose studentID as a prop value (computed so reactivity works)
      ...
      <div class="">
        <div class="card-box">
          ...
          <ul class="nav nav-tabs nav-tabs-bottom">
            <li class="nav-item">
              <a class="nav-link active" href="#bottom-tab1" data-toggle="tab">Overview</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#bottom-tab2" data-toggle="tab">Lessons</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#bottom-tab3" data-toggle="tab">Payments</a>
            </li>
             <li class="nav-item">
              <a class="nav-link" href="#bottom-tab4" data-toggle="tab">Documents</a>
            </li>
          </ul>

          <div class="tab-content">
            <div class="tab-pane show active" id="bottom-tab1"> <StudentDetails :student-id="studentID" /></div>
