              ...
              <div class="card-body">
                <div class="chart-title">
                  ...
                  <span class="float-right"
                    ><i class="fa fa-caret-up" aria-hidden="true"></i> 15% Higher than Last
                    Month</span
                  >
                </div>
                    ...
                    <tbody>
                      <tr>
                        <td style="min-width: 200px">
                          ...
                          <h2>
                            <a href="profile.html">Bernardo Galaviz <span>New York, USA</span></a>
                          </h2>
                        </td>
                        <td>
                        ...
                        <td class="text-right">
                          <a href="appointments.html" class="btn btn-outline-primary take-btn"
                            >Take up</a
                          >
                        </td>
                      </tr>
                      ...
                      <div class="float-left user-img m-r-10">
                        <a href="profile.html" title="John Doe"
                          ><img
                            ...
                            alt=""
                            class="w-40 rounded-circle" /><span class="status online"></span
                        ></a>
                      </div>
                      ...
                      <div class="float-left user-img m-r-10">
                        <a href="profile.html" title="Richard Miles"
                          ><img
                            src="/assets/img/user.jpg"
                            alt=""
                            class="w-40 rounded-circle" /><span class="status offline"></span
                        ></a>
                      </div>
                      <div class="contact-info">
                      ...
                      <div class="float-left user-img m-r-10">
                        <a href="profile.html" title="John Doe"
                          ><img
                            src="/assets/img/user.jpg"
                            alt=""
                            class="w-40 rounded-circle" /><span class="status away"></span
                        ></a>
                      </div>
                      <div class="contact-info">
                        <span class="contact-name text-ellipsis">John Doe</span>
